...
- Architecture Mermaid/SVG files are the only instructional visuals, and command output remains the canonical live evidence.
- Complete lifecycle script implementations are synchronized into every lab README.
