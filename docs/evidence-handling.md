# CLI and PowerShell evidence handling

The canonical evidence for a live-tested lab is the machine-readable result produced by its Azure CLI or PowerShell validation stage. Architecture diagrams are the repository's visual learning aids; Azure Portal captures are not part of the lab contract.
