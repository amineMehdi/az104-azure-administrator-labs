...
|---|---|
| `CP-CONTAINERS-01` | Create and manage an Azure Container Registry |
| `CP-CONTAINERS-02` | Provision a container by using Azure Container Instances |
...
![Lab 13 architecture](diagrams/architecture.svg)
...
The key design idea is: **ACR stores image artifacts and ACI runs container groups; registry admin credentials are not required when managed identities or scoped tokens are available.**
...
- Choose a unique run ID matching `^[a-z0-9-]+$`, such as `az104l13-01`.
...
- [https://learn.microsoft.com/en-us/azure/container-registry/container-registry-get-started-azure-cli](https://learn.microsoft.com/en-us/azure/container-registry/container-registry-get-started-azure-cli)
- [https://learn.microsoft.com/en-us/azure/container-registry/container-registry-import-images](https://learn.microsoft.com/en-us/azure/container-registry/container-registry-import-images)
