# Lab 13 solution and diagnostic notes
...
1. **Checkpoint 1:** Create a globally unique Basic ACR with the admin account disabled.
2. **Checkpoint 2:** Import a public Microsoft sample image and inspect repository and tag metadata.
3. **Checkpoint 3:** Create an ACI container group using a managed identity or time-bounded registry authentication path.
4. **Checkpoint 4:** Inspect CPU, memory, restart policy, events, logs, and current container state.
