...
|---|---:|---|---|
| `01-virtual-network-address-space.png` | 1 | Virtual network > Address space | Non-overlapping hub and spoke prefixes |
| `02-virtual-network-subnets.png` | 1 | Virtual network > Subnets | Application and management subnet boundaries |
| `03-virtual-network-peerings.png` | 2 | Virtual network > Peerings | Connected bidirectional peerings |
| `04-public-ip-address-overview.png` | 3 | Public IP address > Overview | Standard SKU, static allocation, and zones |
