# Lab 17 solution and diagnostic notes
...
1. **Checkpoint 1:** Create hub and spoke address spaces that do not overlap and subdivide them into purpose-specific subnets.
2. **Checkpoint 2:** Create both sides of VNet peering and interpret Connected, Initiated, and Disconnected states.
3. **Checkpoint 3:** Create a zone-redundant Standard static public IP where supported.
4. **Checkpoint 4:** Compare private address planning, public IP allocation, DNS labels, and effective peering routes.
