...
Describe 'LAB-16 offline lifecycle contract' {
    BeforeAll {
        ...
        $script:CheckpointIds = @('LAB16-CP01', 'LAB16-CP02', 'LAB16-CP03', 'LAB16-CP04', 'LAB16-CP05')
        $script:OptionalCheckpointIds = @('LAB16-CP04')
