...
1. **Checkpoint 1:** Create two backend NICs/VMs in an NSG-protected subnet without individual public IPs.
...
The permission boundary is: Network Contributor and Virtual Machine Contributor on the lab resource group
