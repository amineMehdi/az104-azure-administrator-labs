...
The curriculum contains 28 numbered, standalone lab folders. Labs 01–25 are independent by default; capstones may reuse state only through an explicitly documented accelerated path.
