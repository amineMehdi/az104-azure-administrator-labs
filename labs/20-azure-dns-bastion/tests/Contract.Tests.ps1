...
Describe 'LAB-20 offline lifecycle contract' {
    BeforeAll {
        ...
        $script:CheckpointIds = @('LAB20-CP01', 'LAB20-CP02', 'LAB20-CP03', 'LAB20-CP04', 'LAB20-CP05')
        $script:OptionalCheckpointIds = @('LAB20-CP04')
