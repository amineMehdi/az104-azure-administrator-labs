...
### Checkpoint 1: Create a correctly named and sized AzureBastionSubnet with a Standard static public IPCreate a correctly named and sized AzureBastionSubnet with a Standard static public IP.Evidence to retain:- The command output or exact resource/object ID for checkpoint 1.- A positive assertion proving the intended state.- A negative assertion showing that broader or anonymous access was not introduced.- Any asynchronous operation state, timestamp, and final result.### Checkpoint 2: Deploy Azure Bastion and inspect SKU, scale units, and supported native-client featuresDeploy Azure Bastion and inspect SKU, scale units, and supported native-client features.Evidence to retain:- The command output or exact resource/object ID for checkpoint 2.- A positive assertion proving the intended state.- A negative assertion showing that broader or anonymous access was not introduced.- Any asynchronous operation state, timestamp, and final result.### Checkpoint 3: Create an isolated Azure DNS public zone and A/CNAME/TXT records using a lab-owned labelCreate an isolated Azure DNS public zone and A/CNAME/TXT records using a lab-owned label.Evidence to retain:- The command output or exact resource/object ID for checkpoint 3.- A positive assertion proving the intended state.- A negative assertion showing that broader or anonymous access was not introduced.- Any asynchronous operation state, timestamp, and final result.### Checkpoint 4: Verify authoritative name servers and perform external delegation only for AZ104_OWNED_DNS_ZONEVerify authoritative name servers and perform external delegation only for AZ104_OWNED_DNS_ZONE.Evidence to retain:- The command output or exact resource/object ID for checkpoint 4.- A positive assertion proving the intended state.- A negative assertion showing that broader or anonymous access was not introduced.- Any asynchronous operation state, timestamp, and final result.
