...
Describe 'LAB-02 offline lifecycle contract' {
    BeforeAll {
        ...
        $script:CheckpointIds = @('LAB02-CP01', 'LAB02-CP02', 'LAB02-CP03', 'LAB02-CP04', 'LAB02-CP05')
        $script:OptionalCheckpointIds = @('LAB02-CP03', 'LAB02-CP04', 'LAB02-CP05')
