...
Describe 'LAB-04 offline lifecycle contract' {
    BeforeAll {
        ...
        $script:CheckpointIds = @('LAB04-CP01', 'LAB04-CP02', 'LAB04-CP03', 'LAB04-CP04', 'LAB04-CP05')
        $script:OptionalCheckpointIds = @('LAB04-CP05')
