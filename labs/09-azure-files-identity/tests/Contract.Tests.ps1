...
Describe 'LAB-09 offline lifecycle contract' {
    BeforeAll {
        ...
        $script:CheckpointIds = @('LAB09-CP01', 'LAB09-CP02', 'LAB09-CP03', 'LAB09-CP04', 'LAB09-CP05')
        $script:OptionalCheckpointIds = @('LAB09-CP04')
