# Lab 10 solution and diagnostic notes
...
1. **Checkpoint 1:** Build and lint the supplied Bicep file and inspect its generated ARM JSON.
2. **Checkpoint 2:** Modify parameter values and run a resource-group what-if before deployment.
3. **Checkpoint 3:** Deploy through Azure CLI and inspect deployment operations and outputs.
4. **Checkpoint 4:** Export the resource group template and decompile a reviewed ARM template into a separate comparison file.
