# Lab 15 solution and diagnostic notes
...
1. **Checkpoint 1:** Create a Linux App Service plan and web app with deterministic names.
2. **Checkpoint 2:** Scale the plan manually and configure bounded CPU-based autoscale where the SKU supports it.
3. **Checkpoint 3:** Create a staging slot and mark an application setting as a deployment-slot setting.
4. **Checkpoint 4:** Warm and swap staging into production, then verify which settings followed content and which remained sticky.
...
The permission boundary is: Website Contributor and Monitoring Contributor on the lab resource group
