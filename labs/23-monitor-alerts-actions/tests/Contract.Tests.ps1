...
Describe 'LAB-23 offline lifecycle contract' {
    BeforeAll {
        ...
        $script:CheckpointIds = @('LAB23-CP01', 'LAB23-CP02', 'LAB23-CP03', 'LAB23-CP04', 'LAB23-CP05')
        $script:OptionalCheckpointIds = @('LAB23-CP04')
