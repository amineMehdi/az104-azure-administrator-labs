# Lab 19 solution and diagnostic notes
...
1. **Checkpoint 1:** Create separate service-endpoint and private-endpoint subnets with appropriate policies.
2. **Checkpoint 2:** Enable Microsoft.Storage service endpoints and add a storage virtual-network rule.
3. **Checkpoint 3:** Create a blob private endpoint and approve its private link connection.
4. **Checkpoint 4:** Link privatelink.blob.core.windows.net to the VNet and verify the private A record and network policy differences.
...
The permission boundary is: Network Contributor and Storage Account Contributor on the lab resource group
