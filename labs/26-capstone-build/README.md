...
|---|---:|---|---|
| `01-resource-group-overview.png` | 1 | Resource group > Overview | Complete tagged deployment inventory |
| `02-network-topology.png` | 2 | Network topology | Subnets, NSGs, private endpoint, and load balancer |
| `03-resource-group-access-control-and-policies.png` | 3 | Resource group > Access control and Policies | Scoped RBAC and policy evidence |
| `04-monitor-logs-and-alerts.png` | 4 | Monitor > Logs and Alerts | Diagnostics, query results, and alert rules |
