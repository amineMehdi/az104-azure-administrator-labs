...
Describe 'LAB-26 offline lifecycle contract' {
    BeforeAll {
        ...
        $script:CheckpointIds = @('LAB26-CP01', 'LAB26-CP02', 'LAB26-CP03', 'LAB26-CP04', 'LAB26-CP05')
        $script:OptionalCheckpointIds = @('LAB26-CP04')
