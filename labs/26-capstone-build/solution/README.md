...
1. **Checkpoint 1:** Run Bicep build and what-if, then deploy the governed resource group and deterministic tags.
...
The permission boundary is: Contributor, User Access Administrator, Resource Policy Contributor, and Monitoring Contributor on the capstone resource group

The live gate is: Requires AZ104_PRINCIPAL_OBJECT_ID for the RBAC checkpoint; the workload path remains deployable without assigning a role when the value is absent.
